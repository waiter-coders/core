...
class Transfer
{
    ...
    {
        $query = Database::table($this->daoConfig->table, $this->daoConfig->database);
    ...
    public function getTrueFields($fields)
    {
        ...
        foreach ($fields as $field) {
            if (isset($this->daoConfig->fields[$field])) {
                $fieldParams = $this->daoConfig->fields[$field];
                $trueFields[] = isset($fieldParams['trueField']) ? $fieldParams['trueField'] : $this->daoConfig->table .'.' . $field;
